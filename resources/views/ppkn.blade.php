...
<section class="max-w-7xl mx-auto px-6 pt-16 pb-12">
    ...
    <div class="mt-12">
        <div class="w-full h-80 bg-gray-200 flex items-center justify-center">
            <img src="{{ asset('images/ppkn-hero.jpg') }}" 
    ...
    <div class="grid md:grid-cols-2 gap-16 items-center">
        <div>
            ...
            <div class="flex gap-16">
                ...
                <div>
                    <p class="text-5xl font-bold mb-1">32%</p>
        ...
        <div class="bg-gray-200 h-96">
            <img src="{{ asset('images/ppkn-stat.jpg') }}" 
                 alt="Statistik PPKN" 
                 class="w-full h-full object-cover">
        </div>
    </div>
...
<section class="max-w-7xl mx-auto px-6 py-20">
    ...
    <div class="grid md:grid-cols-3 gap-6">
        <!-- CARD PANCASILA -->
        <div class="relative overflow-hidden h-96 bg-amber-800">
            <img src="{{ asset('images/pancasila.jpg') }}" 
                 alt="Pancasila" 
                 class="w-full h-full object-cover">
            <div class="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end p-6">
                <div class="text-white">
                    <h4 class="font-bold text-xl mb-1">Pancasila</h4>
                    <p class="text-sm opacity-90">Memahami nilai-nilai dasar Pancasila sebagai fondasi kehidupan berbangsa yang menjunjung tinggi persatuan, keadilan, dan kebhinekaan.</p>
                </div>
            </div>
        </div>
        ...
        <div class="relative overflow-hidden h-96 bg-gray-900">
            <img src="{{ asset('images/konstitusi.jpg') }}" 
                 alt="Konstitusi" 
                 class="w-full h-full object-cover">
            <div class="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end p-6">
                <div class="text-white">
                    <h4 class="font-bold text-xl mb-1">Konstitusi</h4>
                    <p class="text-sm opacity-90">Mempelajari UUD 1945 dan sistem hukum Indonesia untuk memahami hak serta kewajiban sebagai warga negara yang baik.</p>
                </div>
            </div>
        </div>

        <!-- CARD BHINNEKA TUNGGAL IKA -->
        <div class="relative overflow-hidden h-96 bg-red-800">
            <img src="{{ asset('images/bhinneka.jpg') }}" 
                 alt="Bhinneka Tunggal Ika" 
                 class="w-full h-full object-cover">
            <div class="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end p-6">
                <div class="text-white">
                    <h4 class="font-bold text-xl mb-1">Bhinneka Tunggal Ika</h4>
                    <p class="text-sm opacity-90">Menghargai keberagaman suku, agama, dan budaya sebagai kekayaan bangsa yang memperkuat persatuan Indonesia.</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="max-w-7xl mx-auto px-6 py-20">
    <div class="grid md:grid-cols-2 gap-16 items-center">
        <div class="bg-gray-200 h-96">
            <img src="{{ asset('images/why-calcera.jpg') }}" 
                 alt="Mengapa Calcera" 
                 class="w-full h-full object-cover">
        </div>
        ...
        <div>
            ...
            <p class="text-gray-600 mb-8 leading-relaxed">
                Calcera adalah platform pembelajaran online dengan pendekatan personal yang
                dirancang khusus untuk membantu siswa menguasai materi dengan lebih mudah, hasil
                belajar akan lebih maksimal dan siswa akan termotivasi untuk belajar lebih lanjut.
            </p>
            ...
            <div class="space-y-4">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600">Materi disajikan secara runtut dan mudah dipahami oleh siswa</p>
                    </div>
                </div>
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600">Sistem evaluasi yang komprehensif untuk mengukur pemahaman siswa</p>
                    </div>
                </div>
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <h4 class="font-semibold mb-1">Materi Terlengkap</h4>
                        <p class="text-sm text-gray-600">Semua topik tersedia dan terupdate sesuai kurikulum terbaru</p>
                    </div>
                </div>
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <h4 class="font-semibold mb-1">Akses Praktis</h4>
                        <p class="text-sm text-gray-600">Belajar kapan saja dan di mana saja sesuai dengan jadwal Anda</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="grid md:grid-cols-5 gap-4">
            <div class="bg-white p-8 text-center">
                ...
                <p class="text-xs text-gray-600">Buat akun baru atau login dengan akun yang sudah ada untuk memulai belajar</p>
            </div>
            ...
            <div class="bg-white p-8 text-center">
                ...
                <h4 class="font-semibold mb-2">Pilih Mata Pelajaran</h4>
                <p class="text-xs text-gray-600">Pilih mata pelajaran yang ingin dipelajari sesuai kebutuhan Anda</p>
            </div>
            ...
            <div class="bg-white p-8 text-center">
                ...
                <p class="text-xs text-gray-600">Akses materi pembelajaran yang lengkap dengan penjelasan yang detail</p>
            </div>
            ...
            <div class="bg-white p-8 text-center">
                ...
                <p class="text-xs text-gray-600">Kerjakan kuis untuk menguji pemahaman Anda terhadap materi</p>
            </div>
            ...
            <div class="bg-white p-8 text-center">
                ...
                <h4 class="font-semibold mb-2">Lanjut Materi Berikutnya</h4>
                <p class="text-xs text-gray-600">Lanjut ke materi berikutnya setelah menyelesaikan materi sebelumnya</p>
            </div>
        </div>
    </div>
</section>
